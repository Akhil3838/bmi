...
`;
  ...
  const result=()=>{
     setBMI((value / (height / 100) ** 2).toFixed(1))
     instruction(BMI);

  }
  //condition
  const [category,setcategory]=React.useState("condition")
  const [discription,setdiscription]= React.useState("solution for it")

  const instruction=(BMI)=>{
    let category ='';
    let discription = '';
    ...
    if (BMI<=18.5) {
      ...
      discription='Eat healthy foods';
      
    }
    else if(BMI>=18.5 && BMI<=24.9){
      category='HEALTHY !';
      discription='Stay healthy';

    }
    else if(BMI>=25.0 && BMI<=39.9){
      category='OVERWEIGHT';
      discription='reduced-calorie diet and exercise regularly';
     ...
     category="OBESE !";
      discription='go to medical checkup';
...
<div className='d-flex align-items-center justify-content-center'>
        <div className="row w-75">
          ...
          <div className="col-md-8 ">
              ...
              <div className="row  p-3 mb-5 shadow-lg  mt-5  rounded-4 p-3 py-4 " style={{backgroundColor:'#1A2421'}}>
              
             <h2 className='text-center mt-3 fw-bold text-white '>BMI calculator</h2>
             ...
             <div>
                 ...
                 <div className='w-100 text-center'>
                    <h4 className=' fw-bold text-success '>{category}</h4>
               ...
               {/* width */}
                <div style={{ width: "250px" }} className='mt-4' >
                  <Typography id="input-slider" gutterBottom>
                   <span className='fw-bolder text-white'> weight</span>
                 ...
                 <div className=''>
                  ...
                  <Input className='text-white shadow-lg'
                    value={value}
                    size="small"
                    variant="standard"
                    color=''
                ...
                <div style={{ width: '250px', marginTop: '20px' }}>
                  <Typography id="height-slider" gutterBottom>
                   <span className='fw-bolder text-white'> Height</span>
                    <FontAwesomeIcon icon={faArrowRight} fade className='ms-2 text-white' />
                  </Typography>
                  <Slider 
